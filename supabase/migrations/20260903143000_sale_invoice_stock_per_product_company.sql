-- Sale invoices may mix products from different brand companies.
-- Deduct stock from each product's assigned company (default_warehouse_id),
-- falling back to the invoice warehouse when unset.
