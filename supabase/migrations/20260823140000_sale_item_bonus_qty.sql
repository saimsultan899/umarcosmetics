-- Item-wise bonus (free goods) on sale lines; stock out = qty + bonus_qty
...
begin
  ...
  insert into public.sale_invoices (
    ...
    salesman_id, route, city, payment_type, subtotal, discount_total, grand_total,
    amount_paid, narration, status, created_by, updated_by
  ) values (
  ...
  loop
    ...
    -- Stock out paid qty + free bonus pieces
  ...
  -- Receivable: full sale debit (bonus is free — not billed)
